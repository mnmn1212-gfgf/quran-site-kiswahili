...
const ACCENT = "#D6B16F";
const CTA_DARK = "#1B263B";

// Swahili Coast Luxe palette: midnight ocean, carved wood, old brass, and moonlit blue.

const OUTER_GRADIENT =
  "bg-[linear-gradient(135deg,rgba(9,19,33,0.96)_0%,rgba(28,40,64,0.94)_34%,rgba(58,73,110,0.90)_68%,rgba(121,76,58,0.84)_100%)]";
const INNER_GRADIENT =
  "bg-[linear-gradient(135deg,rgba(8,16,28,0.98)_0%,rgba(20,30,48,0.94)_52%,rgba(50,64,96,0.88)_100%)]";
...
function HeroAudioPlayer({ isMobile }) {
  ...
  return (
    <div className="mt-5 rounded-[1.35rem] border border-white/10 bg-[#0D1726]/68 p-3 sm:p-4">
      <audio
        ref={audioRef}
        preload="metadata"
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-gradient-to-r from-white/5 to-white/10 px-4 py-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-[#6E8FB3]/14">
        ...
        <div className="mt-4 rounded-2xl border border-white/10 bg-[#0D1726]/68 px-4 py-4 text-sm leading-7 text-white/78 sm:text-base sm:leading-8">
          {desc}
        </div>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        ...
        <div
          className={`mt-4 rounded-2xl border border-white/10 bg-[#0D1726]/68 px-4 py-4 text-white/80 ${
            large
...
function ImpactCard({ icon: Icon, title, desc, isMobile }) {
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-gradient-to-r from-white/5 to-white/10 px-4 py-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-[#D6B16F]/14">
            <Icon className="h-5 w-5" style={{ color: ACCENT }} />
          </div>
...
function ProtectedHlsVideoCard({
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 rounded-[1.3rem] border border-white/10 bg-[#0D1726]/68 p-3 sm:p-4">
        <div className="flex flex-wrap items-center gap-2">
          <button
            type="button"
            onClick={toggleMute}
...
export default function QuranTranslationLandingPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      <div
        dir="ltr"
        className="relative min-h-screen overflow-hidden bg-transparent text-white selection:bg-[#E7C98A]/30"
      >
        ...
        {!isMobile && (
          <>
            <motion.div
              className="absolute -top-24 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-[#6E8FB3]/16 blur-3xl"
              animate={pulseGlow}
            />
        ...
        <div className={containerClass}>
          <header className="pt-4 sm:pt-6">
            ...
            >
              <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border border-amber-200/20 bg-white/10 shadow-[0_0_18px_rgba(214,177,111,0.18)] sm:h-16 sm:w-16">
                  <img
                    src={sanaLogo}
              ...
              >
                <div className="rounded-[1.6rem] border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-4 sm:p-6">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="w-fit rounded-2xl border border-[#6E8FB3]/25 bg-[#6E8FB3]/16 px-4 py-2 text-xs text-[#DCE8F5] sm:text-sm">
                      Matangazo ya moja kwa moja
                    </div>
                  </div>

                  <div className="mt-6 rounded-[1.4rem] border border-white/10 bg-[#16243A]/78 p-4 sm:mt-8 sm:p-6">
          ...
          <section className="py-8 lg:py-12">
            ...
            >
              {!isMobile && (
                <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_20%,rgba(39,121,167,0.16),transparent_28%),radial-gradient(circle_at_80%_80%,rgba(231,201,138,0.12),transparent_32%)]" />
              )}

              <div className="relative z-10">
                <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch lg:gap-8">
                  <div className="rounded-[1.8rem] border border-white/10 bg-[#0D1726]/62 p-4 sm:p-6">
                  ...
                  <div className="rounded-[1.8rem] border border-white/10 bg-[#0D1726]/76 p-4 sm:p-6">
                    <div className="flex h-full flex-col justify-center rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-5 inline-flex w-fit items-center gap-2 rounded-2xl border border-[#D6B16F]/25 bg-[#D6B16F]/10 px-5 py-3 text-sm text-[#F3E4C8] transition hover:bg-sky-400/20 sm:text-base"
                      >
                  ...
                  <div className="rounded-[1.5rem] border border-white/10 bg-white/5 p-4 sm:p-5">
                    ...
                    <div className="space-y-3 text-white/75">
                      ...
                      <a
                        ...
                        className="flex items-center justify-center gap-3 rounded-2xl border border-[#D6B16F]/24 bg-[#D6B16F]/10 px-4 py-3 text-center text-sm font-semibold text-[#F3E4C8] transition hover:bg-sky-400/20 sm:text-base"
                      >
              ...
              <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr_1fr]">
                ...
                <div className="rounded-[1.6rem] border border-white/10 bg-white/5 p-4 sm:p-5 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="w-full space-y-4 text-white/72">
                    <a
                      href="mailto:snachannel159@gmail.com"
                      className="flex items-center justify-center gap-3 break-all rounded-2xl border border-white/10 bg-[#0D1726]/68 px-4 py-3 text-sm transition hover:bg-white/10 sm:text-base"
                    >
                      <Mail className="h-4 w-4 shrink-0" style={{ color: ACCENT }} />
                      snachannel159@gmail.com
                    </a>

                    <div className="flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-[#0D1726]/68 px-4 py-3 text-sm sm:text-base">
                      <MapPin className="h-4 w-4 shrink-0" style={{ color: ACCENT }} />
                      Amman - Jordan
                    </div>
                  </div>

                  <div className="mt-6 w-full rounded-[1.4rem] border border-white/10 bg-[#0D1726]/62 p-4">
                    <a
                ...
                <div className="rounded-[1.8rem] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.08),rgba(255,255,255,0.04))] p-4 backdrop-blur-md sm:p-5 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="w-full rounded-[1.4rem] border border-white/10 bg-[#0D1726]/62 p-4">
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      ...
                      >
                        <div className="flex items-center justify-center gap-3">
                          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-[#6E8FB3]/14 text-white">
                            <GooglePlayIcon />
                          </div>
                      ...
                      >
                        <div className="flex items-center justify-center gap-3">
                          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-[#D6B16F]/14 text-white">
                            <AppStoreIcon />
                          </div>
                    ...
                    <div className="mt-5 rounded-[1.4rem] border border-white/10 bg-[#16243A]/72 p-4">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-[#D6B16F]/24 bg-[#D6B16F]/10 py-3 text-sm font-bold text-[#F3E4C8] transition hover:scale-[1.01] hover:bg-sky-400/20"
                      >
