...
const ACCENT = "#E7C58F";
const CTA_DARK = "#343B4B";

// Swahili Twilight Velvet palette: deep navy, slate violet, rosewood haze, and soft brass glow.

const OUTER_GRADIENT =
  "bg-[linear-gradient(135deg,rgba(4,20,50,0.98)_0%,rgba(29,46,84,0.95)_36%,rgba(73,84,118,0.92)_70%,rgba(121,84,71,0.88)_100%)]";
const INNER_GRADIENT =
  "bg-[linear-gradient(135deg,rgba(25,37,66,0.96)_0%,rgba(61,74,107,0.92)_52%,rgba(113,94,98,0.88)_100%)]";
...
const glass =
  "border border-white/10 bg-[linear-gradient(135deg,rgba(7,22,52,0.86)_0%,rgba(41,57,92,0.74)_50%,rgba(117,87,79,0.52)_100%)] md:backdrop-blur-xl backdrop-blur-sm shadow-[0_18px_40px_rgba(0,0,0,0.22)]";
...
function ProtectedHlsVideoCard({
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[1.4rem] border border-white/10 bg-black/35">
        <video
          ref={videoRef}
          src={video}
        ...
        {!isPlaying && (
          ...
          >
            <span className="flex h-16 w-16 items-center justify-center rounded-full border border-white/20 bg-white/10 backdrop-blur-md shadow-[0_0_22px_rgba(39,121,167,0.22)] sm:h-18 sm:w-18">
...
export default function QuranTranslationLandingPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(214,177,111,0.12),transparent_28%),radial-gradient(circle_at_82%_18%,rgba(110,143,179,0.16),transparent_24%),radial-gradient(circle_at_18%_82%,rgba(140,106,67,0.14),transparent_22%),linear-gradient(180deg,#060B13_0%,#0C1422_36%,#1A2438_68%,#4A3A33_100%)]" />
        ...
        <div className={containerClass}>
          <header className="pt-4 sm:pt-6">
            ...
            >
              <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border border-[#E7C58F]/20 bg-white/10 shadow-[0_0_22px_rgba(231,197,143,0.16)] sm:h-16 sm:w-16">
                  <img
                    src={sanaLogo}
              ...
              <nav className="hidden items-center gap-3 md:flex">
                {navItems.map((item) => (
                  <a
                    key={item.href}
                    href={item.href}
                    className="rounded-full border border-white/10 bg-white/5 px-4 py-2 text-sm font-medium text-white/85 transition hover:border-[#D6B16F]/35 hover:bg-white/10 hover:text-[#F1DEC0]"
                  >
                    {item.label}
                  </a>
                ))}
          ...
          <section className="relative grid min-h-[auto] items-center gap-10 py-10 sm:gap-12 sm:py-14 lg:min-h-[84vh] lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
            <div className="order-1 lg:order-1">
              <motion.div
                ...
                animate="show"
                variants={fadeUp}
                className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#E7C58F]/20 bg-white/10 px-4 py-2 text-xs backdrop-blur-md sm:text-sm"
                style={{ color: ACCENT }}
              >
            ...
            >
              ...
              <div className="relative z-10">
                <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch lg:gap-8">
                  ...
                  <div className="rounded-[1.8rem] border border-white/10 bg-[#0D1726]/76 p-4 sm:p-6">
          ...
          <section id="contact" className="py-8 lg:py-12">
            ...
            >
              ...
              >
                <div className="rounded-[2rem] border border-white/10 bg-[#0D1726]/76 p-4 sm:p-6">
              ...
              <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr_1fr]">
                ...
                <div className="rounded-[1.6rem] border border-white/10 bg-white/5 p-4 sm:p-5 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="w-full space-y-4 text-white/72">
                    <a
                      href="mailto:snachannel159@gmail.com"
                      className="flex items-center justify-center gap-3 break-all rounded-2xl border border-white/10 bg-[linear-gradient(135deg,rgba(37,47,73,0.88)_0%,rgba(74,87,119,0.80)_52%,rgba(120,98,97,0.70)_100%)] px-4 py-3 text-sm transition hover:bg-white/10 sm:text-base"
                    >
