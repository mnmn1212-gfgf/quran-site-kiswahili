...
const ACCENT = "#E7C98A";
const CTA_DARK = "#0D2230";

const OUTER_GRADIENT =
  "bg-[linear-gradient(135deg,rgba(7,35,52,0.94)_0%,rgba(10,52,74,0.92)_45%,rgba(25,88,98,0.88)_100%)]";
const INNER_GRADIENT =
  "bg-[linear-gradient(135deg,rgba(6,24,36,0.96)_0%,rgba(8,36,52,0.90)_100%)]";
...
function HeroAudioPlayer({ isMobile }) {
  ...
  return (
    <div className="mt-5 rounded-[1.35rem] border border-white/10 bg-[#071927]/60 p-3 sm:p-4">
      <audio
        ref={audioRef}
        preload="metadata"
      ...
      <div className="mb-4 flex h-14 items-end gap-[2px] overflow-hidden rounded-2xl border border-white/10 bg-black/10 px-2 py-3 sm:h-18">
        {bars.map((height, index) => (
          <motion.div
            ...
            className="flex-1 self-end rounded-full bg-gradient-to-t from-sky-300 via-amber-200 to-cyan-300 opacity-95"
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <div className="relative h-2 w-full flex-1 overflow-visible rounded-full bg-white/10">
          <div
            className="absolute inset-y-0 right-0 rounded-full bg-gradient-to-r from-sky-300 via-amber-200 to-cyan-300"
  ...
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        ...
        <div className="mt-4 rounded-2xl border border-white/10 bg-[#071927]/60 px-4 py-4 text-sm leading-7 text-white/78 sm:text-base sm:leading-8">
          {desc}
        </div>
      </div>
    </motion.div>
  ...
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        ...
        <div
          className={`mt-4 rounded-2xl border border-white/10 bg-[#071927]/60 px-4 py-4 text-white/80 ${
            large
...
function ImpactCard({ icon: Icon, title, desc, isMobile }) {
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/10 bg-white/5 p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-white/10 bg-gradient-to-r from-white/5 to-white/10 px-4 py-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/10 bg-amber-200/10">
            <Icon className="h-5 w-5" style={{ color: ACCENT }} />
          </div>
...
function ProtectedHlsVideoCard({
  ...
  return (
    ...
    >
      ...
      <div className="mt-4 rounded-[1.3rem] border border-white/10 bg-[#071927]/60 p-3 sm:p-4">
        <div className="flex flex-wrap items-center gap-2">
          <button
            type="button"
            onClick={toggleMute}
...
export default function QuranTranslationLandingPage() {
  ...
  return (
    <LazyMotion features={domAnimation}>
      ...
      >
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(39,121,167,0.22),transparent_30%),radial-gradient(circle_at_80%_20%,rgba(231,201,138,0.12),transparent_24%),radial-gradient(circle_at_20%_80%,rgba(44,163,176,0.16),transparent_24%),linear-gradient(180deg,#020B14_0%,#071C2B_42%,#0A3446_100%)]" />

        {!isMobile && (
          <>
            <motion.div
              className="absolute -top-24 left-1/2 h-96 w-96 -translate-x-1/2 rounded-full bg-cyan-400/16 blur-3xl"
              animate={pulseGlow}
            />
        ...
        <div className={containerClass}>
          <header className="pt-4 sm:pt-6">
            ...
            >
              <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border border-amber-200/20 bg-white/10 shadow-[0_0_16px_rgba(39,121,167,0.22)] sm:h-16 sm:w-16">
                  <img
                    src={sanaLogo}
          ...
          <section className="relative grid min-h-[auto] items-center gap-10 py-10 sm:gap-12 sm:py-14 lg:min-h-[84vh] lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
            <div className="order-1 lg:order-1">
              ...
              >
                <span className="block bg-gradient-to-r from-[#F3E7B3] via-sky-100 to-amber-100 bg-clip-text text-transparent">
                  Sana Quranic Channels
                </span>
              </motion.h1>
              ...
              >
                <div className="rounded-[1.6rem] border border-white/10 bg-gradient-to-br from-white/10 to-white/5 p-4 sm:p-6">
                  <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                    ...
                    <div className="w-fit rounded-2xl border border-sky-300/20 bg-sky-400/15 px-4 py-2 text-xs text-sky-100 sm:text-sm">
                      Matangazo ya moja kwa moja
                    </div>
                  </div>

                  <div className="mt-6 rounded-[1.4rem] border border-white/10 bg-[#0B2334]/75 p-4 sm:mt-8 sm:p-6">
                      ...
                      <div className="space-y-3">
                        {[65, 88, 42].map((w, idx) => (
                          <motion.div
                            ...
                            className="h-3 rounded-full bg-gradient-to-r from-sky-300 via-amber-200 to-cyan-300"
                          />
                        ))}
                      </div>
                    )}
            ...
            >
              ...
              <div className="relative z-10">
                <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch lg:gap-8">
                  <div className="rounded-[1.8rem] border border-white/10 bg-[#071927]/55 p-4 sm:p-6">
                  ...
                  <div className="rounded-[1.8rem] border border-white/10 bg-[#071927]/72 p-4 sm:p-6">
                    <div className="flex h-full flex-col justify-center rounded-2xl border border-white/10 bg-white/5 p-4 sm:p-5">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-5 inline-flex w-fit items-center gap-2 rounded-2xl border border-sky-200/20 bg-sky-400/10 px-5 py-3 text-sm text-sky-100 transition hover:bg-sky-400/20 sm:text-base"
                      >
          ...
          <section id="contact" className="py-8 lg:py-12">
            ...
            >
              ...
              >
                <div className="rounded-[2rem] border border-white/10 bg-[#071927]/72 p-4 sm:p-6">
                  <div className="rounded-[1.5rem] border border-white/10 bg-white/5 p-4 sm:p-5">
                    ...
                    <div className="space-y-3 text-white/75">
                      ...
                      <a
                        ...
                        className="flex items-center justify-center gap-3 rounded-2xl border border-sky-200/20 bg-sky-400/10 px-4 py-3 text-center text-sm font-semibold text-sky-100 transition hover:bg-sky-400/20 sm:text-base"
                      >
            ...
            <div className={`rounded-[2rem] px-4 py-6 sm:px-6 sm:py-8 lg:px-10 ${glass}`}>
              <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr_1fr]">
                ...
                >
                  ...
                  <p className="mx-auto mt-4 max-w-[30rem] rounded-[1.4rem] border border-white/10 bg-[rgba(10,40,60,0.58)] px-4 py-4 text-sm leading-7 text-white/78 sm:px-5 sm:text-base sm:leading-8">
                ...
                <div className="rounded-[1.6rem] border border-white/10 bg-white/5 p-4 sm:p-5 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="w-full space-y-4 text-white/72">
                    <a
                      href="mailto:snachannel159@gmail.com"
                      className="flex items-center justify-center gap-3 break-all rounded-2xl border border-white/10 bg-[#071927]/60 px-4 py-3 text-sm transition hover:bg-white/10 sm:text-base"
                    >
                      <Mail className="h-4 w-4 shrink-0" style={{ color: ACCENT }} />
                      snachannel159@gmail.com
                    </a>

                    <div className="flex items-center justify-center gap-3 rounded-2xl border border-white/10 bg-[#071927]/60 px-4 py-3 text-sm sm:text-base">
                      <MapPin className="h-4 w-4 shrink-0" style={{ color: ACCENT }} />
                      Amman - Jordan
                    </div>
                  </div>

                  <div className="mt-6 w-full rounded-[1.4rem] border border-white/10 bg-[#071927]/55 p-4">
                    <a
                ...
                <div className="rounded-[1.8rem] border border-white/10 bg-[linear-gradient(145deg,rgba(255,255,255,0.08),rgba(255,255,255,0.04))] p-4 backdrop-blur-md sm:p-5 flex flex-col items-center justify-center text-center">
                  ...
                  <div className="w-full rounded-[1.4rem] border border-white/10 bg-[#071927]/55 p-4">
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      ...
                      >
                        <div className="flex items-center justify-center gap-3">
                          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-amber-200/10 text-white">
                            <AppStoreIcon />
                          </div>
                    ...
                    <div className="mt-5 rounded-[1.4rem] border border-white/10 bg-[#0B2334]/68 p-4">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="mt-4 flex w-full items-center justify-center gap-2 rounded-xl border border-sky-200/20 bg-sky-400/10 py-3 text-sm font-bold text-sky-100 transition hover:scale-[1.01] hover:bg-sky-400/20"
                      >
