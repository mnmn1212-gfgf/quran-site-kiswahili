    ...
    <LazyMotion features={domAnimation}>
      ...
      >
        ...
        <div className="absolute inset-0">
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_22px_22px,rgba(232,199,144,0.16)_1.8px,transparent_2.2px),radial-gradient(circle_at_0_0,rgba(255,255,255,0.03)_1px,transparent_1.4px),linear-gradient(45deg,transparent_46%,rgba(232,199,144,0.06)_47%,rgba(232,199,144,0.06)_53%,transparent_54%),linear-gradient(-45deg,transparent_46%,rgba(232,199,144,0.06)_47%,rgba(232,199,144,0.06)_53%,transparent_54%)] bg-[size:48px_48px,24px_24px,96px_96px,96px_96px] [mask-image:linear-gradient(90deg,black_0%,black_18%,transparent_34%,transparent_46%,black_60%,black_74%,transparent_86%,black_100%),linear-gradient(180deg,black_0%,transparent_22%,black_42%,black_58%,transparent_76%,black_100%)] [mask-composite:intersect] opacity-[0.055]" />
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_24px_24px,rgba(232,199,144,0.18)_2px,transparent_2.4px),linear-gradient(45deg,transparent_46%,rgba(232,199,144,0.08)_47%,rgba(232,199,144,0.08)_53%,transparent_54%),linear-gradient(-45deg,transparent_46%,rgba(232,199,144,0.08)_47%,rgba(232,199,144,0.08)_53%,transparent_54%)] bg-[size:56px_56px,112px_112px,112px_112px] [mask-image:radial-gradient(circle_at_18%_24%,black_0%,black_16%,transparent_30%),radial-gradient(circle_at_82%_22%,black_0%,black_14%,transparent_28%),radial-gradient(circle_at_66%_72%,black_0%,black_18%,transparent_34%)] [mask-composite:add] opacity-[0.055]" />
        </div>
        ...
        {!isMobile && (
          <>
            ...
            />
            <motion.div
              className="pointer-events-none absolute -left-[52%] top-[-22%] h-[155%] w-[46%] bg-[linear-gradient(90deg,transparent_0%,rgba(255,255,255,0.00)_16%,rgba(232,199,144,0.08)_34%,rgba(255,255,255,0.18)_50%,rgba(232,199,144,0.08)_66%,rgba(255,255,255,0.00)_84%,transparent_100%)] blur-[28px]"
              animate={sheenSweep}
            />
