...
const glass =
  "border border-white/20 bg-[linear-gradient(135deg,rgba(14,26,50,0.90)_0%,rgba(43,57,88,0.82)_48%,rgba(119,92,86,0.62)_100%)] md:backdrop-blur-xl backdrop-blur-sm shadow-[0_18px_40px_rgba(0,0,0,0.24)]";
const softCard = `rounded-[2rem] ${glass}`;
const gradientOuterCard = `rounded-[2rem] border border-white/20 ${OUTER_GRADIENT} md:backdrop-blur-xl backdrop-blur-sm shadow-[0_8px_22px_rgba(0,0,0,0.14)]`;
...
function sectionBadge(icon, text, textColor = "text-white") {
  ...
  return (
    <div
      className={`inline-flex max-w-full items-center gap-3 rounded-full border border-white/20 bg-[#44536B] px-4 py-2.5 text-xs font-semibold ${textColor} backdrop-blur-md shadow-[0_6px_18px_rgba(0,0,0,0.14)] sm:px-5 sm:py-3 sm:text-sm`}
    >
...
function LargeSectionBadge({ icon: Icon, text }) {
  return (
    <div
      className="inline-flex max-w-full items-center gap-3 rounded-full border border-white/20 bg-[#44536B] px-5 py-3 text-base font-bold backdrop-blur-md shadow-[0_6px_18px_rgba(0,0,0,0.14)] sm:px-8 sm:py-4 sm:text-xl lg:text-2xl"
      style={{ color: ACCENT }}
    >
...
function HeroAudioPlayer({ isMobile }) {
  ...
  return (
    <div className="mt-5 rounded-[1.35rem] border border-white/20 bg-[linear-gradient(135deg,rgba(36,47,74,0.90)_0%,rgba(72,84,116,0.82)_54%,rgba(121,98,96,0.72)_100%)] p-3 sm:p-4">
      <audio
        ref={audioRef}
        preload="metadata"
      ...
      <div className="mb-4 flex h-14 items-end gap-[2px] overflow-hidden rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(23,29,45,0.38)_0%,rgba(50,61,88,0.30)_56%,rgba(98,75,71,0.24)_100%)] px-2 py-3 sm:h-18">
      ...
      <div className="flex flex-wrap items-center gap-2">
        <button
          type="button"
          onClick={togglePlay}
          className="flex h-10 w-10 items-center justify-center rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] text-white transition hover:bg-[#44536B]"
...
function StructuredCard({ icon: Icon, title, desc, isMobile }) {
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-white/20 bg-gradient-to-r from-white/5 to-white/10 px-4 py-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/20 bg-[#B7A1A4]/14">
        ...
        <div className="mt-4 rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(37,47,73,0.88)_0%,rgba(74,87,119,0.80)_52%,rgba(120,98,97,0.70)_100%)] px-4 py-4 text-sm leading-7 text-white/78 sm:text-base sm:leading-8">
          {desc}
        </div>
      </div>
    </motion.div>
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-white/20 bg-gradient-to-r from-white/5 to-white/10 px-4 py-3">
          ...
          <div
            className={`rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] px-4 py-2 font-bold text-white ${
        ...
        <div
          className={`mt-4 rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(37,47,73,0.88)_0%,rgba(74,87,119,0.80)_52%,rgba(120,98,97,0.70)_100%)] px-4 py-4 text-white/80 ${
            large
...
function ImpactCard({ icon: Icon, title, desc, isMobile }) {
  return (
    ...
    >
      <div className="h-full rounded-[1.5rem] border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] p-4">
        <div className="flex items-center gap-3 rounded-2xl border border-white/20 bg-gradient-to-r from-white/5 to-white/10 px-4 py-3">
          <div className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/20 bg-[#E7C58F]/14">
            <Icon className="h-5 w-5" style={{ color: ACCENT }} />
          </div>
...
function ProtectedHlsVideoCard({
  ...
  return (
    ...
    >
      <div className="relative overflow-hidden rounded-[1.4rem] border border-white/20 bg-[linear-gradient(135deg,rgba(18,24,38,0.82)_0%,rgba(35,44,68,0.74)_60%,rgba(74,58,58,0.62)_100%)]">
        <video
          ref={videoRef}
          src={video}
        ...
        {!isPlaying && (
          ...
          >
            <span className="flex h-16 w-16 items-center justify-center rounded-full border border-white/20 bg-[#44536B] backdrop-blur-md shadow-[0_0_22px_rgba(39,121,167,0.22)] sm:h-18 sm:w-18">
              <Play className="mr-1 h-7 w-7 text-white" />
            </span>
          </button>
        )}

        <div className="pointer-events-none absolute left-3 top-3 rounded-full border border-white/20 bg-[linear-gradient(135deg,rgba(18,24,38,0.82)_0%,rgba(35,44,68,0.74)_60%,rgba(74,58,58,0.62)_100%)] px-3 py-1 text-[11px] text-white/80 backdrop-blur-md">
          {isReady ? "Muonekano unaonekana kabla ya kucheza" : "Hakikisho linaandaliwa"}
        </div>
      </div>

      <div className="mt-4 rounded-[1.3rem] border border-white/20 bg-[linear-gradient(135deg,rgba(36,47,74,0.90)_0%,rgba(72,84,116,0.82)_54%,rgba(121,98,96,0.72)_100%)] p-3 sm:p-4">
        <div className="flex flex-wrap items-center gap-2">
          <button
            type="button"
            onClick={toggleMute}
          ...
          <header className="pt-4 sm:pt-6">
            ...
            >
              <div className="flex min-w-0 items-center gap-3 sm:gap-4">
                <div className="flex h-12 w-12 shrink-0 items-center justify-center overflow-hidden rounded-full border border-[#E7C58F]/20 bg-[#44536B] shadow-[0_0_22px_rgba(231,197,143,0.16)] sm:h-16 sm:w-16">
                  <img
                    src={sanaLogo}
              ...
              <nav className="hidden items-center gap-3 md:flex">
                {navItems.map((item) => (
                  <a
                    key={item.href}
                    href={item.href}
                    className="rounded-full border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] px-4 py-2 text-sm font-medium text-white/85 transition hover:border-[#D6B16F]/35 hover:bg-[#44536B] hover:text-[#F1DEC0]"
                  >
                    {item.label}
                  </a>
                ))}
              ...
              <button
                ...
                className="flex h-11 w-11 shrink-0 items-center justify-center rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] md:hidden"
              >
                ...
                <div className="grid gap-2">
                  {navItems.map((item) => (
                    <a
                      ...
                      className="rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] px-4 py-3 text-sm text-white/85 sm:text-base"
                    >
                      {item.label}
                    </a>
                  ))}
          ...
          <section className="relative grid min-h-[auto] items-center gap-10 py-10 sm:gap-12 sm:py-14 lg:min-h-[84vh] lg:grid-cols-[1.05fr_0.95fr] lg:py-20">
            <div className="order-1 lg:order-1">
              <motion.div
                ...
                animate="show"
                variants={fadeUp}
                className="mb-5 inline-flex items-center gap-2 rounded-full border border-[#E7C58F]/20 bg-[#44536B] px-4 py-2 text-xs backdrop-blur-md sm:text-sm"
                style={{ color: ACCENT }}
              >
              ...
              >
                {stats.map((item, i) => (
                  <motion.div
                    ...
                    className="rounded-3xl border border-white/20 bg-[#44536B] p-3 text-center backdrop-blur-md shadow-[0_6px_16px_rgba(0,0,0,0.12)] sm:p-4"
                  >
            ...
            >
              ...
              >
                <div className="rounded-[1.6rem] border border-white/20 bg-gradient-to-br from-white/10 to-white/5 p-4 sm:p-6">
                  ...
                  <div className="mt-6 rounded-[1.4rem] border border-white/20 bg-[linear-gradient(135deg,rgba(44,57,88,0.92)_0%,rgba(83,97,130,0.84)_55%,rgba(129,104,102,0.76)_100%)] p-4 sm:mt-8 sm:p-6">
                    ...
                    <div className="mt-6 grid grid-cols-3 gap-2 text-center sm:mt-8 sm:gap-3">
                      {heroCards.map((item) => (
                        <div
                          key={item.label}
                          className="rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] p-3 sm:p-4"
                        >
              ...
              <div className="mx-auto mt-5 grid max-w-2xl gap-3 sm:mt-6 sm:flex sm:flex-wrap sm:items-center sm:justify-center sm:gap-4">
                {heroBadges.map((item) => {
                  ...
                  return (
                    <div
                      key={item.title}
                      className="w-full rounded-[1.4rem] border border-white/20 bg-[#44536B] px-5 py-4 text-center backdrop-blur-md shadow-[0_6px_16px_rgba(0,0,0,0.12)] sm:min-w-[220px] sm:w-auto sm:rounded-[1.6rem]"
                    >
                      <div className="flex items-center justify-center gap-3">
                        <div className="flex h-10 w-10 items-center justify-center rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] sm:h-11 sm:w-11">
                          <Icon className="h-5 w-5" style={{ color: ACCENT }} />
                        </div>
            ...
            >
              ...
              <div className="relative z-10">
                <div className="grid gap-6 lg:grid-cols-2 lg:items-stretch lg:gap-8">
                  <div className="rounded-[1.8rem] border border-white/20 bg-[linear-gradient(135deg,rgba(34,46,73,0.86)_0%,rgba(70,83,114,0.78)_52%,rgba(119,96,94,0.68)_100%)] p-4 sm:p-6">
                    <div className="h-full rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] p-4 sm:p-5">
                  ...
                  <div className="rounded-[1.8rem] border border-white/20 bg-[linear-gradient(135deg,rgba(17,28,49,0.82)_0%,rgba(44,56,85,0.74)_60%,rgba(107,82,79,0.58)_100%)] p-4 sm:p-6">
                    <div className="flex h-full flex-col justify-center rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] p-4 sm:p-5">
          ...
          <section id="contact" className="py-8 lg:py-12">
            ...
            >
              <div className="text-center">
                <div
                  className="inline-flex max-w-full items-center gap-3 rounded-full border border-white/20 bg-[#44536B] px-5 py-3 text-base font-semibold backdrop-blur-md shadow-[0_6px_16px_rgba(0,0,0,0.12)] sm:px-7 sm:py-4 sm:text-lg"
                  style={{ color: ACCENT }}
                >
              ...
              >
                <div className="rounded-[2rem] border border-white/20 bg-[linear-gradient(135deg,rgba(17,28,49,0.82)_0%,rgba(44,56,85,0.74)_60%,rgba(107,82,79,0.58)_100%)] p-4 sm:p-6">
                  <div className="rounded-[1.5rem] border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] p-4 sm:p-5">
          ...
          <footer className="pb-8 pt-4 sm:pb-10">
            <div className={`rounded-[2rem] px-4 py-6 sm:px-6 sm:py-8 lg:px-10 ${glass}`}>
              <div className="grid gap-6 lg:grid-cols-[1.2fr_0.8fr_1fr]">
                <div
                  className={`rounded-[1.8rem] border border-white/20 p-4 text-center sm:p-6 ${INNER_GRADIENT} flex h-full flex-col items-center justify-center`}
                >
                  <div className="mx-auto flex h-20 w-20 items-center justify-center rounded-full border border-white/15 bg-[#44536B] shadow-[0_0_18px_rgba(255,255,255,0.06)] backdrop-blur-md sm:h-24 sm:w-24">
                    <img
                      src={sanaLogo}
                      alt="Nembo ya Sana"
                  ...
                  <div className="mt-4">
                    <span className="inline-flex rounded-full border border-white/20 bg-[#44536B] px-4 py-2 text-xs text-white/90 sm:px-5 sm:text-sm">
                      Vituo vya Qurani vya Sana
                    </span>
                  </div>
                  ...
                  <p className="mx-auto mt-4 max-w-[30rem] rounded-[1.4rem] border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] px-4 py-4 text-sm leading-7 text-white/78 sm:px-5 sm:text-base sm:leading-8">
                ...
                <div className="rounded-[1.6rem] border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] p-4 sm:p-5 flex flex-col items-center justify-center text-center">
                  <div className="mb-5 flex flex-col items-center justify-center gap-4 text-lg font-bold text-white sm:text-xl">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] shadow-[0_8px_18px_rgba(0,0,0,0.14)]">
                  ...
                  <div className="w-full space-y-4 text-white/72">
                    <a
                      href="mailto:snachannel159@gmail.com"
                      className="flex items-center justify-center gap-3 break-all rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(37,47,73,0.88)_0%,rgba(74,87,119,0.80)_52%,rgba(120,98,97,0.70)_100%)] px-4 py-3 text-sm transition hover:bg-[#44536B] sm:text-base"
                    >
                      <Mail className="h-4 w-4 shrink-0" style={{ color: ACCENT }} />
                      snachannel159@gmail.com
                    </a>

                    <div className="flex items-center justify-center gap-3 rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(37,47,73,0.88)_0%,rgba(74,87,119,0.80)_52%,rgba(120,98,97,0.70)_100%)] px-4 py-3 text-sm sm:text-base">
                      <MapPin className="h-4 w-4 shrink-0" style={{ color: ACCENT }} />
                      Amman - Jordan
                    </div>
                  </div>

                  <div className="mt-6 w-full rounded-[1.4rem] border border-white/20 bg-[linear-gradient(135deg,rgba(34,46,73,0.86)_0%,rgba(70,83,114,0.78)_52%,rgba(119,96,94,0.68)_100%)] p-4">
                    <a
                      href="https://www.facebook.com/share/1FVbmggbzc/"
                      target="_blank"
                      rel="noreferrer"
                      className="flex items-center justify-center gap-2 rounded-xl border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] py-3 text-sm font-semibold text-white transition hover:scale-[1.01] hover:bg-[#44536B]"
                    >
                ...
                <div className="rounded-[1.8rem] border border-white/20 bg-[linear-gradient(145deg,rgba(255,255,255,0.08),rgba(255,255,255,0.04))] p-4 backdrop-blur-md sm:p-5 flex flex-col items-center justify-center text-center">
                  <div className="mb-5 flex flex-col items-center justify-center gap-4 text-lg font-bold text-white sm:text-xl">
                    <div className="flex h-14 w-14 items-center justify-center rounded-2xl border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] shadow-[0_8px_18px_rgba(0,0,0,0.14)]">
                  ...
                  <div className="w-full rounded-[1.4rem] border border-white/20 bg-[linear-gradient(135deg,rgba(34,46,73,0.86)_0%,rgba(70,83,114,0.78)_52%,rgba(119,96,94,0.68)_100%)] p-4">
                    ...
                    <div className="grid gap-3 md:grid-cols-2">
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="group rounded-[1.3rem] border border-white/20 bg-[linear-gradient(135deg,rgba(42,52,78,0.34)_0%,rgba(72,82,109,0.28)_56%,rgba(121,95,88,0.18)_100%)] p-4 transition hover:-translate-y-0.5 hover:bg-[#44536B]"
                      >
                        <div className="flex items-center justify-center gap-3">
                          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/20 bg-[#B7A1A4]/14 text-white">
                            <GooglePlayIcon />
                          </div>
                      ...
                      >
                        <div className="flex items-center justify-center gap-3">
                          <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/20 bg-[#E7C58F]/14 text-white">
                            <AppStoreIcon />
                          </div>
                    ...
                    <div className="mt-5 rounded-[1.4rem] border border-white/20 bg-[linear-gradient(135deg,rgba(44,57,88,0.88)_0%,rgba(83,97,130,0.80)_55%,rgba(129,104,102,0.72)_100%)] p-4">
              ...
              <div className="mt-8 border-t border-white/20 pt-5 text-center text-xs text-white/55 sm:text-sm">
